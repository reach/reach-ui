...
<Helmet
  ...
  meta={[
    {
      name: "description",
      content: "A dynamic version of React.Component, a component component if you will."
    }
  ]}
/>
...
Similar to `children`, but must be a function

```.jsx
<Component>
  {({ state, props, refs, setState, forceUpdate }) => (
