...
<TOC>
	<TOCList>
		...
		<TOCLink href="#dialogwrapper">DialogWrapper</TOCLink>
...
| Prop                                         | Type   | Required |
| -------------------------------------------- | ------ | -------- |
| [`Portal` props](#dialogportal-portal-props) |        |          |
| [`isOpen`](#dialogportal-isopen)             | `bool` | false    |

##### DialogWrapper `Portal` props

Any props not listed above will be spread onto the underlying [`<Portal />`](./portal#portalprops).

```jsx
<DialogWrapper containerRef={domRef}>
	<DialogInner>
		<DialogContent>
			<p>The underlying portal will render into another DOM element</p>
		</DialogContent>
	</DialogInner>
</DialogWrapper>
```

##### DialogWrapper `isOpen`
