...
This is especially useful when you need to pass extra information to your `onSelect` handler. This is most commonly used when in need to display extra information about the item after selection, or to do an item lookup by passing the id/index of an item when part of a dynamic list.
