...
## Ignore styles in your tests

The warning will show up while running your tests. To avoid this, you can mock out the `checkStyles` function in the `@reach/utils` package. In Jest, you can add this snippet before your tests run:
