...
| [`keepScrollPosition`](#menu-keepscrollposition) | `boolean` | false    |
...
##### Menu `keepScrollPosition`

`keepScrollPosition: boolean`

When a menu is open the focus is trasferred to the menu itself. In the case the menu list element height is larger than the window height this focus will scroll the page making it jumpy.
Passing `true` on this prop will still focus on the menu element but keeping the position of the scroll on the page.
