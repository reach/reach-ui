export { Example as Basic } from "./basic.example";
...
export { Example as WithButton } from "./with-button.example";
export { Example as WithCustomSelectDataTs } from "./with-custom-select-data.example";
